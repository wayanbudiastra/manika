                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="{{url('perawat/'.Crypt::encrypt($data->id).'/update')}}" class="form" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="card-body">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group form-group-default">
                                            ...
                                            <input name="nama_perawat" type="text" class="form-control" placeholder="Nama Perawat" value="{{$data->nama_perawat}}">
                                        </div>
                                        <div class="form-group form-group-default">
                                            <label>Email Perawat</label>
                                            <input name="email" type="email" class="form-control" placeholder="Email Perawat" value="{{$data->email}}" readonly>
                                        </div>
                                        <div class="form-group form-group-default">
                                            <label>Telepon</label>
                                ...
                                <div class="card-footer">
                                    <div class="form-group">
                                        <a href="/perawat" class="btn btn-danger">Close</a>
