                                ...
                                <div class="table-responsive">
                                    <table id="basic-datatables" class="display table table-striped table-hover">
                                        ...
                                        @foreach($data as $k)
                                            <tr>
                                                <td>{{$no=$no+1}}</td>
                                                <td>{{$k->nama_spesialis}}</td>
                                                <td>{{$k->spesialis->nama_spesialis}}</td>
                                                <td>{{$k->keterangan}}</td>
                                                <td>{!!  ($k->aktif == "Y") ? '<span class="btn btn-success">Ya</span>' : ('<span class="btn btn-danger">Tidak</span>')!!}</td>
                                                <td>
                                                    <center><a href="{{url('/subspesialis/'.$k->id.'/edit')}}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{url('/subspesialis')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group form-group-default">
                                        <label>Aktif</label>
                                        <label class="radio-inline"><input type="radio" name="aktif" value="Y">
                                            Ya</label>
                                        <label class="radio-inline"><input type="radio" name="aktif" value="N">
                                            Tidak</label>
                                    </div>
                                </div>
